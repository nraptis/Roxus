...
void TestMiniWindow::PositionContent() {
    //Log("---PositionContent(TestMiniWindow)\n");
}

void TestMiniWindow::Update() {
    mSpriteRotation += 2.0;
...
void TestMiniWindow::TouchDown(float pX, float pY, void *pData) {
    
}

void TestMiniWindow::TouchMove(float pX, float pY, void *pData) {
    
}

void TestMiniWindow::TouchUp(float pX, float pY, void *pData) {
    
}

void TestMiniWindow::TouchFlush() {
