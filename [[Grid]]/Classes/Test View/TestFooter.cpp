...
TestFooter::TestFooter() {
    ...
    mBadgeLeft = new TestBadge();
    AddSubview(mBadgeLeft);

    mBadgeRight = new TestBadge();
    AddSubview(mBadgeRight);
...
void TestFooter::PositionContent() {

    //Log("---PositionContent(TestFooter)\n");
    ...
    if (mParent) {
        ...
        if (aParentWidth > 24.0f && aParentHeight > 24.0f && mWidth > 24.0f && mHeight > 24.0f) {
            ...
            SetPos(aFit.mX, aParentHeight - (mHeight * aScale + aBorderSize));
        }
    }
...
void TestFooter::Update() {

}

void TestFooter::Draw() {
    FView::Draw();
...
void TestFooter::TouchDown(float pX, float pY, void *pData) {

}

void TestFooter::TouchMove(float pX, float pY, void *pData) {

}

void TestFooter::TouchUp(float pX, float pY, void *pData) {

}

void TestFooter::TouchFlush() {
