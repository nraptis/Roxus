...
void GameArena::DrawGridSelection()
{
    ...
    if((mCursorGridX != -1) && (mCursorGridY != -1))
    {
        ...
        DrawRect(0.0f, aTop, gArenaWidth, gTileHeight);
        DrawRect(aLeft, 0.0f, gTileWidth, gArenaHeight);
    }
...
void GameArena::Save(const char *pPath)
{
    ...
    *aArenaTag += aTileListTag;
    ...
    XMLTag *aPathListTag = new XMLTag("path_list");
