...
public:
    ...
    inline void                     Corner1SetTexCoord(float pU, float pV, float pW){mVertex[QUAD_INDEX_1].mU=pU;mVertex[QUAD_INDEX_1].mV=pV;mVertex[QUAD_INDEX_1].mW=pW;}
    inline void                     Corner1SetTexCoord(float pU, float pV){Corner1SetTexCoord(pU, pV, 0.0f);}
    ...
    inline void                     Corner2SetTexCoord(float pU, float pV, float pW){mVertex[QUAD_INDEX_2].mU=pU;mVertex[QUAD_INDEX_2].mV=pV;mVertex[QUAD_INDEX_2].mW=pW;}
    inline void                     Corner2SetTexCoord(float pU, float pV){Corner2SetTexCoord(pU, pV, 0.0f);}
    ...
    inline void                     Corner3SetTexCoord(float pU, float pV, float pW){mVertex[QUAD_INDEX_3].mU=pU;mVertex[QUAD_INDEX_3].mV=pV;mVertex[QUAD_INDEX_3].mW=pW;}
    inline void                     Corner3SetTexCoord(float pU, float pV){Corner3SetTexCoord(pU, pV, 0.0f);}
    ...
    inline void                     Corner4SetTexCoord(float pU, float pV, float pW){mVertex[QUAD_INDEX_4].mU=pU;mVertex[QUAD_INDEX_4].mV=pV;mVertex[QUAD_INDEX_4].mW=pW;}
    inline void                     Corner4SetTexCoord(float pU, float pV){Corner4SetTexCoord(pU, pV, 0.0f);}
