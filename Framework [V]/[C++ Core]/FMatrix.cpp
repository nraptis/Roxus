...
FMatrix FMatrixCreateLookAt(float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float aCenterZ, float aUpX, float upY, float upZ) {
    float aNX = eyeX - centerX;
    float aNY = eyeY - centerY;
