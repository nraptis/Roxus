...
{
    Graphics::DrawModelIndexed(mXYZ, mUVW, mNormal, mIndex, mIndexCount, mTexture);
}

void FModelDataIndexed::Draw(FTexture *pTexture)
{
    Graphics::DrawModelIndexed(mXYZ, mUVW, mNormal, mIndex, mIndexCount, pTexture);
}
