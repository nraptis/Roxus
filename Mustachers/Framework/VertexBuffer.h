...
public:
    ...
    void                StereoscopicShift(float pShiftMin, float pShiftMax, VertexBuffer *pBuffer, Color pColorOuter=Color(1.0f,0.5f,0.5f,0.25f), Color pColorInner=Color(1.0f,1.0f,1.0f,0.65f));
