...
- (void)go
{
    //NSLog(@"Pushing GL View");
    
    //[self.view addSubview:gRoot.view];
    //[super go];
    //[self.view addSubview:gGlViewController.view];
    ...
    //self.lightMenu = [[LightMenu alloc] initWithNibName:nil bundle:nil];
    //[self.view addSubview:lightMenu.view];
