...
- (void)setupOpenGL {
    if (glViewController == nil) {
        ...
        gOpenGLView = PlatformOpenGLView::createWithEAGLView(NULL);
        //initWithEAGLView()
        //gO
...
- (void)viewDidLoad {
    ...
    //[NSThread detachNewThreadSelector:@selector(theThread) toTarget:self withObject:nil];
