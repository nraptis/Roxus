...
int os_core_main(int argc, char **argv) {
    ...
    gOpenGLView = PlatformOpenGLView::createWithRect("My Game", FRect(gWindowX, gWindowY, gWindowWidth, gWindowHeight), 1.0, true);
    
    //::createWithRect("SimpleGame", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
    ...
    //gOpenGLView->setWindowed(gWindowWidth, gWindowHeight);
