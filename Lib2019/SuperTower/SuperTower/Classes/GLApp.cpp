...
GLApp::GLApp() {
    ...
    //vector<int> aNums = {2,0,5,6,16,12,15,12,4};
    
    //splitArraySameAverage(aNums);
}
...
void GLApp::Draw() {
    ...
    Graphics::Clear(0.0, 0.25f, 0.65f);
    
    Graphics::SetColor(1.0f, 0.25f, 0.25f, 0.6f);
    Graphics::DrawRect(20.0f, 20.0f, gDeviceWidth - 40.0f, 180.0f);
    
    Graphics::SetColor(0.0f, 1.0f, 0.25f, 0.6f);
    Graphics::DrawLine(0.0f, 0.0f, gDeviceWidth, gDeviceHeight, 4.0);
    Graphics::DrawLine(gDeviceWidth, 0.0f, 0.0f, gDeviceHeight);
    
    Graphics::SetColor();
    
    mTileTunnel.Draw(100.0, 100.0);
}
